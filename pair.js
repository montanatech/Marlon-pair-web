...
👋🏻 Hello there,MARLON-XMD User!

> ⚠️ *Do not share your session ID with your GF!* 🤖

✅ **Thanks for using MARLON-XMD**  🚀
...
externalAdReply: {
title: "Marlon xmd",
thumbnailUrl: "https://files.catbox.moe/eypc3z.jpg",
sourceUrl: "https://github.com/montanatech/MARLON-Xmd",
mediaType: 1,
...
{quoted:code })
                            ...
                            let desc = `*Don't Share with anyone this code use for deploy MARLON-XMD*\n\n ◦ *Github:* https://github.com/montanatech/MARLON-Xmd`;
                            await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
